import { changeProperty, getHead, listenDocumentEvent } from '$lib/document';
...
const injectStyle = (source:string, head:HTMLHeadElement = getHead()) => {
...
const injectScript = (source:string, head:HTMLHeadElement = getHead()) => {
